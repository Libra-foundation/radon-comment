...
describe("Tree tests", () => {
    ...
    test("Tree -- merge: recursive", () => {
        ...
        expect((TREE.get('test_2') as Tree<string>).get('test_3')).toEqual('test_3');

        TREE_3.set('test_3', 'test_4')
        expect((TREE.get('test_2') as Tree<string>).get('test_3')).toEqual('test_4');
        ...
        expect((TREE.get('test_2') as Tree<string>).get('test_3')).toEqual('test_4');
        expect((TREE.get('test_2') as Tree<string>).get('test_5')).toEqual('test_5');
